...
EPIC_MONO=""
if [ -f "C:\Program Files\Epic Games\UE_4.20\Engine\Build\BatchFiles\Mac\SetupMono.sh" ]; then
    pushd "C:\Program Files\Epic Games\UE_4.20\Engine\Build\BatchFiles\Mac"
	source SetupMono.sh
    popd
else
	EPIC_MONO="NOTE: It seems this $0 was built from another platform and copied here.\nNOTE: Was expecting to setup mono via: "'C:\Program Files\Epic Games\UE_4.20\Engine\Build\BatchFiles\Mac\SetupMono.sh';
fi
